...
This drops support for `fork-ts-checker-webpack-plugin` versions < 5 - if you need to use one of those versions then please use  https://www.npmjs.com/package/fork-ts-checker-notifier-webpack-plugin/v/2.0.0
